...
Similarly, be wary of user modifications to maps or slices exposing pkg
state.
...
- Allow users to observe or control type pkgs.
...
that records information in some pkg struct. You accept a variadic number
